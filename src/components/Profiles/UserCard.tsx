...
const UserCard: React.FC<UserCardProps> = ({
  ...
  lastTripDate,
  noOfTrips,
  tripsImage="/Overview/No. of trips icon.svg",
  co2Avoided,
  co2Image ="/Profile/Component 5.svg",
  credsEarned,
  credsEarnedImage="/Overview/Total Creds Icon.svg",
  credsRedeemed,
  credsRedeemedImage="/Overview/points-and-dollars-exchange-svgrepo-com 2.svg",
}) => {
  return (
